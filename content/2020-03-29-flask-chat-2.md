...
It had a [W3C / WHATWG standard](https://html.spec.whatwg.org/multipage/web-sockets.html)
and was moved to [IETF](https://tools.ietf.org/html/draft-hixie-thewebsocketprotocol-75).

## Scaling

A single server can handle $2^{16} = 65536$ sockets per single IP address.[^1]
You might want to limit the number of connections your app makes. Otherwise,
it could happen that you can't ssh into your server anymore. For more details, see
[^1],[^2],[^3].
