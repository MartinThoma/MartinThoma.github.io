...
a sailing course. I hiked the [GR 20](../gr-20/),
finished my first via ferrata ([Alpspitz-Ferrata](../alpspitze-via-ferrata/)),
...
In December, I got the chance to go to [NIPS 2016](../nips-2016/)
...
* I wrote 53&nbsp;articles for this blog (including this one) in 2016. A couple
  of them might be interesting for a very specific audience ([SVMs](../svm-with-sklearn/), [classifier comparison](../comparing-classifiers/),
  [machine learning glossary](../ml-glossary/)).
* I've uploaded 835&nbsp;files to Wikimedia Commons in 2016 (<a href="http://tools.wmflabs.org/ptools/uploadsum.php?user=MartinThoma">source</a>). My uploads to Wikimedia Commons
...
* <span style="color:green;">&#x2714;</span> 03.11.2016: I painted some walls in my apartment (not all, though).
...
4. Speech synthesis will quickly improve. To benchmark this, I will use the
   ...
   Galaxy. See [Towel Day](https://en.wikipedia.org/wiki/Towel_Day), [Google Translate Recording](../audio/2016-01-04-towel-quote-google.ogg), [Festival Recording](../audio/2016-01-04-towel-quote-festival.ogg) <span style="color:red;">&#x2717;</span>
...
9. I will publish at least 40&nbsp;articles on my blog.<br/>
...
14. The Republican candidate will become president. <span style="color:#37a32f;font-weight:bold">Correct</span>
...
* [ ] Get all my stuff from my father's apartment to my room. I've already packed
...
* <span style="color:green;">&#x2714;</span> Deleting several hundred e-mails.
* <span style="color:green;">&#x2714;</span> Clean up my smartphone's TODO list.
* [ ] Clean up my notes.
...
8. The [European Union](https://en.wikipedia.org/wiki/European_Union) will
   ...
   be going in front of court because of it
