...
tags: Klausur, Computer Vision, University, AI
...
<tr>
    ...
    <td>Model-based approaches, Appearance-based approaches</td>
</tr>
<tr>
    <td>14</td>
    <td>02.12.2016</td>
    <td>Person Detection</td>
    <td>Introduction, HOG people detector, Silhouette matching</td>
</tr>
<tr>
    <td>15</td>
    <td>05.12.2016</td>
...
<tr>
    ...
    <td>HMMs; Pro Geste ein HMM trainieren</td>
</tr>
<tr>
    <td>18</td>
    <td>27.01.2017</td>
...
* Classification
    * [**SVM**](../svm-with-sklearn/)
    * [EM-Algorithmus](../machine-learning-2-course/#em-algorithmus) (Expectation Maximization)
    * Perceptron-Algorithmus
    * k nearest neighbor (<a href="https://de.wikipedia.org/wiki/Mahalanobis-Distanz">Mahalanobis-Distanz</a>)
* Clustering
    * [k-means](../k-nearest-neighbor-classification-interactive-example/)
    * [Agglomerative Hierarchical Clustering](../machine-learning-1-course/#ahc)
* [Curse of Dimensionality](../curse-of-dimensionality/)
* Dimensionality reduction
    * [PCA](../neuronale-netze-vorlesung/#pca)
    * LDA
...
<dl>
    ...
    <dd>Maximizes class separability (LDA)</dd>
</dl>
...
<dl>
    ...
    <dd>Die ROC-Kurve misst die Abwägung zwischen True-Positive-Rate ($\frac{TP}{Pos}$, y-Achse) und False Positive Rate ($\frac{FP}{Neg}$, x-Achse).</dd>
...
<dl>
    ...
    <dd>
        ...
        <ul>
            ...
            <li>Open Set recognition: First known/unknown, then closed set.</li>
        </ul>
...
<dl>
    ...
    <dd>
        ...
        <br/>
        Pooling wird separat pro Feature-Map angewendet.
...
<dl>
    ...
    <dd>The entropy $H$ of a discrete random variable $X$ is
        ...
        $$H(X) = \mathbb{E}[-\log_2(P(X))] = - \sum_{i=1}^n P(x_i) \log_2 P(x_i)$$
...
* Represent shape and texture (learned separately): $x \approx \bar{x} + P_s b_s$,
  where $P_s$ are the eigenvectors of the covariance matrix; $b_s = P_s^T (x-\bar{x})$
...
<dl>
    ...
    <dd>
        ...
        <ul>
            <li>Valence-Arousal Modell von Russell 1980</li>
            <li>Facial Action Coding System (FACS)</li>
        </ul>
    ...
    <dd><ul>
        ...
        <ul>
            <li>30 Gesichtsmuskeln (12 upper, 18 lower)</li>
    ...
    <dd>
        <ul>
            <li>Cohn-Kanade AU-Coded Facial Expression Database</li>
...
<dl>
    ...
    <dd>Person detection (sometimes also pedestrian detection) is the
        ...
        bounding boxes, although tight segmentation methods exist.<br/>
        <br/>
        ...
        Silhouette matching is a discriminative, global, single image approach.
    ...
    <dd>TODO</dd>
    <dt>Silhouette Matching</dt>
    <dd>

        Silhouette matching is practically not used anymore. It uses chamfer
        matching, 2/3 distance. It can be sped up with a template hierarchy.
...
<dl>
    ...
    <dd>Topologies
        ...
        <ul>
            <li>Stereo cameras (cars)</li>
            <li>wide baseline multi-camera system (conference room)</li>
            <li>non-overlapping fields of view (security system)</li>
        </ul>

        Kalibrierung: Intrinsische und extrinsische Parameter z.B. mit Schachbrettmuster bestimmen.
    </dd>
...
<dl>
    ...
    <dd>Gesten bedeuten nicht überall dasselbe. Ein Nicken bedeutet in
...
<dl>
    ...
    <dd>Zielgerichtete Interaktion mit der Umgebung; tendenziell mit wenigen
    ...
    <dt><dfn>HOG</dfn> (<dfn>Histogram of Oriented Gradients</dfn>)</dt>
...
* pinhole model, calibration (extrinsische / intrinsische Parameter),
...
<summary>Was ist das Hauptproblem der Gesichtserkennung?</summary>
<div class="answer">
Beleuchtung / Pose mismatch (ECCV'94), Occlusion, illumination
</div>
</details>

<details class="question">
<summary>Welche farbbasierten Ansätze gibt es zur Gesichtserkennung?</summary>
<div class="answer">
...
<details class="question">
<summary>Welche featurebasierten Ansätze gibt es zur Gesichtserkennung?</summary>
<div class="answer">
...
<details class="question">
<summary>Wofür steht DCT und AAM?</summary>
<div class="answer">
TODO
</div>
</details>
...
<details class="question">
<summary>PCA vs LDA: Was ist zur Face Recognition besser?</summary>
<div class="answer">
...
<details class="question">
<summary>Wozu ist die Histogram Equalization gut?</summary>
<div class="answer">
TODO
</div>
</details>
...
<details class="question">
<summary>Welche featurebasierten Ansätze gibt es zur Face Recognition?</summary>
<div class="answer">
Facial Features (Abstand der Augen) vs Appearance-based
</div>
</details>

<details class="question">
<summary>Warum macht man Tracking und nicht einfach Frame-weise Detection?</summary>
<div class="answer">
...
<details class="question">
<summary>Was sind Anwendungen von Action und Activity Recognition?</summary>
<div class="answer">
...
<details class="question">
<summary>Was ist Kalibrierung?</summary>
<div class="answer">
TODO
</div>
</details>
...
<details class="question">
<summary>Woher kommt die Skalen-Invarianz bei SIFT?</summary>
<div class="answer">
...
<details class="question">
<summary>Woher kommt die Rotationsinvarianz bei SIFT?</summary>
<div class="answer">
...
<details class="question">
<summary>Was ist der Unterschied zwischen diskriminativen und generativen Modellen?</summary>
<div class="answer">
...
<details class="question">
<summary>Wie funktioniert Histogram Backprojection?</summary>
<div class="answer">
TODO
</div>
</details>
...
<details class="question">
<summary>Welche Metriken kann man zum Benchmarken benutzen?</summary>
<div class="answer">
ROC, TP-Rate, FP-Rate
</div>
</details>
...
<details class="question">
<summary>Was macht Computer Vision schwer?</summary>
<div class="answer">
...
<details class="question">
<summary>Welche Annahmen macht man im Kalman-Filter, die man nicht im Particle-Filter hat?</summary>
<div class="answer">
TODO
</div>
</details>
...
<details class="question">
<summary>Welche Anwendungen gibt es für CV in der HCI?</summary>
<div class="answer">
...
<details class="question">
<summary>Auf welcher Ebene, wann und wie werden Informationen zusammengeführt (z.B. Face / Pose)?</summary>
<div class="answer">
TODO
</div>
</details>
...
* [Content-based Image and Video Retrieval](https://cvhci.anthropomatik.kit.edu/600_1482.php) - 3 ECTS, 2 SWS
