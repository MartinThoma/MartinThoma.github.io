...
tags: LaTeX, Version Control, Productivity
---
...
<ul>
  ...
  <ul>
    <li><strong>Dead end</strong>: Once in a while I got stuck while writing. I tried to improve some part of the documentation, but it didn't work. So I want to jump back. It is much more convenient to jump back in a versioning system than to press <kbd>CTRL</kbd> + <kbd>Z</kbd> often or to create copies of the old version.</li>
  ...
  <li><strong>Accessibility</strong>: To open LaTeX, you only need a text editor. If you want to compile it, you have to get one of many free LaTeX distributions like TeX-Live. After compiling it you get a PDF. PDFs look always the same, so you don't have the problem of shifted margins.</li>
...
I like editing the source code directly very much. To do so, I use <a href="../configurig-gedit-for-developers/">gEdit</a>. When I press <kbd>Ctrl</kbd>+<kbd>M</kbd>, my LaTeX document gets saved, compiled and the temporary files are thrown away. If you want this, you should follow these instructions.
...
<ul>
  ...
  <li><a href="../software-versioning-cheat-sheet/">Software Versioning Cheat Sheet</a></li>
</ul>
