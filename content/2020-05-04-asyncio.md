...
The following images show the difference for two compute-bound tasks:

<figure>
    <a href="../images/2020/05/parallel-execution.svg"><img src="../images/2020/05/parallel-execution.svg" alt="Parallel Execution" width="512" height="175"></a>
    <figcaption>Parallel Execution</figcaption>
</figure>

<figure>
    <a href="../images/2020/05/interleaved-execution.svg"><img src="../images/2020/05/interleaved-execution.svg" alt="Interleaved Execution" width="512" height="175" loading="lazy"></a>
    <figcaption>Interleaved Execution</figcaption>
</figure>

Now you might wonder why on earth you would ever run things interleaved as it
...
<figure>
    <a href="../images/2020/05/file-explorer.png"><img src="../images/2020/05/file-explorer.png" alt="A file explorer" width="512" height="228" loading="lazy"></a>
    <figcaption>A file explorer</figcaption>
</figure>
...
for the thumbnail-calculation into memory. This takes more time than calculating the
...
This means that for interleaved tasks to speed up the total running time of the
...
```python
"""'Hello World' example for multiprocessing in Python."""
...
```python
"""'Hello World' example for multithreading in Python."""
...
A more exciting example would be downloading many files (e.g. ImageNet)
or a link-checker.
...
statement suspends the execution until the expression after the keyword returns. This
...
point as well. You might get a feeling for it by looking at my [article about basic operations](../simple-operations/#latency).
...
and web framework which allows the usage of async/await.
...
<a href="https://palletsprojects.com/governance/">Flask's governance document</a> misses
...
I don't know anybody who has used it, and I don't know what it does.
