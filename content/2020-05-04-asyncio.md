...
<figure class="wp-caption aligncenter img-thumbnail">
    <a href="../images/2020/05/parallel-execution.png"><img src="../images/2020/05/parallel-execution.png" alt="Parallel Execution" style="width: 512px;"/></a>
    <figcaption class="text-center">Parallel Execution</figcaption>
</figure>

<figure class="wp-caption aligncenter img-thumbnail">
    <a href="../images/2020/05/interleaved-execution.png"><img src="../images/2020/05/interleaved-execution.png" alt="Interleaved Execution" style="width: 512px;"/></a>
...
<table class="table">
    ...
    <tbody>
        <tr>
            <td>Packages</td>
            <td><a href="https://docs.python.org/3/library/multiprocessing.html"><code>multiprocessing</code></a></td>
