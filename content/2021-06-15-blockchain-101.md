...
---
<figure>
    <a href="../images/2021/06/blockchain-101-1.jpg"><img src="../images/2021/06/blockchain-101-1.jpg" alt="Photo by Dmitry Demidko on Unsplash" width="2000" height="1333"></a>
...
*Coins, Utility and Security tokens, Stablecoins and NFTs: Bringing order to an ecosystem*](../cryptocurrency-types/)
...
<figure>
    <a href="../images/2021/06/blockchain-101-2.png"><img src="../images/2021/06/blockchain-101-2.png" alt="Image by Martin Thoma" width="1803" height="843" loading="lazy"></a>
...
<figure>
    <a href="../images/2021/06/blockchain-101-3.png"><img src="../images/2021/06/blockchain-101-3.png" alt="Anna sees new blocks from Bob and Charlie. They all have the same green blocks, but Bob discarded the blue blocks in which he sent money to Charlie. He created the red and the yellow ones to fool Anna. Image by Martin Thoma." width="1893" height="693" loading="lazy"></a>
    <figcaption>Anna sees new blocks from Bob and Charlie. They all have the same green blocks, but Bob discarded the blue blocks in which he sent money to Charlie. He created the red and the yellow ones to fool Anna. Image by Martin Thoma.</figcaption>
</figure>
...
A well-known consensus algorithm is **proof of work** as used by Bitcoin (and by
Ethereum until it switched to proof of stake in September 2022, see [The Merge](https://en.wikipedia.org/wiki/Ethereum#The_Merge)), but **proof of stake** and several others exist as well.
...
If they have the same blocks, they have the same blockchain. There could be several different blockchains for one protocol, for example, Ethereum Classic ([ETC](https://coinmarketcap.com/de/currencies/ethereum-classic/)) and Ethereum ([ETH](https://coinmarketcap.com/de/currencies/ethereum/)). One network should always use the same protocol and work on the same blockchain.
