...
tags: Notebooks, Review, Hardware
...
<figure class="wp-caption aligncenter img-thumbnail">
    <a href="../images/2025/05/notebooks-2025.png"><img src="../images/2025/05/notebooks-2025.png" alt="A laptop with RAM, SSD, Wi-Fi and battery icons" style="max-height: 512px"/></a>
    <figcaption class="text-center">Illustration generated with Claude AI: A laptop with RAM, SSD, Wi-Fi and battery icons</figcaption>
</figure>
...
The names Wi-Fi 1 to Wi-Fi 3 are not official; they were only assigned
retroactively when the Wi-Fi Alliance introduced the numbering with Wi-Fi 4-6 in 2018.
...
<table>
    ...
    <tr>
        ...
        <td>16&nbsp;GB (DDR4; 8&nbsp;GB soldered + 8&nbsp;GB in the single SODIMM slot), max. 24&nbsp;GB</td>
        <td>16&nbsp;GB (DDR4-2400) + 1 free SODIMM slot up to 32 GB</td>
        <td>16&nbsp;GB (DDR4-2666) + 1 free SODIMM slot up to 32 GB</td>
    </tr>
    <tr>
        <td>Storage</td>
        <td>512&nbsp;GB (SAMSUNG MZ7LN512, SATA 6&nbsp;Gb/s via M.2)</td>
    ...
    <tr>
        <th colspan="5">Wireless Connectivity</th>
    </tr>
    <tr>
        <td>Wi-Fi</td>
    ...
    <tr>
        <th colspan="5">Wired Connectivity</th>
    </tr>
    <tr>
