...
tags: Politics, Society, Internet
...
supports Trump as a candidate.<sup>[<a href="#ref-snopes-07-2016" name="ref-snopes-07-2016-anchor">Evo16</a>]</sup> Another example is that Denzel Washington supports Trump.<sup>[<a href="#ref-bump-11-2016" name="ref-bump-11-2016-anchor">Bum16</a>]</sup>
...
<ol>
    <li>Speed: Facebook might have problems identifying fake news before it gets viral</li>
...
themselves as trustworthy as possible. In networks like LinkedIn, this might be
...
with Luke Popovich themselves (then I'd expect a note that he was interviewed
...
make statements. Also when politicians do so. Just like <a href="https://www.youtube.com/watch?v=9P1IVQJdVvE">Trevor Noah suggests to adapt to Donald Trump's Lies</a>.


### Build a Journalist Network

Currently, it is harder than necessary to check the reputation of a journalist.
I suggest we should build a web service which allows journalists and news
...
would add their sources to every statement. Imagine you could check an author's
reputation as easily as I described it. Do you really think it would be that simple
...
* [Bullshit detector](https://chrome.google.com/webstore/detail/bs-detector/dlcgkekjiopopabcifhebmphmfmdbjod): A Chrome extension that warns users about unreliable news
...
* [<a href="#ref-bump-11-2016-anchor" name="ref-bump-11-2016">Bum16</a>] Philip Bump. Denzel Washington endorsed Trump, according to AmericaNews, Breitbart, USANewsHome — and Facebook. Washington Post, 14.11.2016.
