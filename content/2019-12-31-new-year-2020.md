...
* I wrote only 50&nbsp;articles for this blog (including this one, not counting 15 ones which were published as a cleanup) in 2019. A couple
  of them might be interesting:
      * [Simple Operations and Basic Numbers](https://martin-thoma.com/simple-operations/) gives an idea of how fast different operations are
      ...
      * 10 recipes, including [vegetable curry](https://martin-thoma.com/vegetable-curry/), [crispy tuna and tofu](https://martin-thoma.com/crispy-thuna/) and [Shrimps and Tofu](https://martin-thoma.com/shrimps-and-tofu/)
