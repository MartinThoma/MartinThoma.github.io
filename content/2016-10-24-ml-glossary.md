...
<dl>
    ...
    <dd>Bias is a concept which describes a systematic error. A classifier
        ...
        the input is. This concept is related to <i>variance</i> and well
    ...
    <dd>A form of semi-supervised learning. Two independent classifiers are
    ...
    <dt><dfn id="dcgan">DCGAN</dfn> (<dfn>Deep Convolutional Generative Adversarial Networks</dfn>)</dt>
    <dd>TODO</dd>
    <dt><dfn id="dcign">DCIGN</dfn> (<dfn>Deep Convolutional Inverse Graphics Network</dfn>)</dt>
    <dd>TODO</dd>
    ...
    <dd>Object detection in an image is a computer vision task. The input
        ...
        A photo could contain no face or hundreds of them. The rectangles
        can overlap.</dd>
    ...
    <dt><dfn id="mmd">MMD</dfn> (<dfn id="maximum-mean-descripancy">Maximum Mean Discrepancy</dfn>)</dt>
    ...
    <dd>Regularization refers to techniques to make the fitted function smoother. This
    ...
    <dd>Reinforcement learning is a sub-field of machine learning, which focuses
