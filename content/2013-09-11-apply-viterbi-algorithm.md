...
---
The goal of the Viterbi algorithm is to find the most likely sequence of hidden states given some observed events.
...
Please note that there might be multiple paths with the highest probability.
