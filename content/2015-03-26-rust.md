...
category: Code
tags: Rust, Programming Language, Programming
...
similarly fast, give the programmer similar fine-grained control over memory
...
* [benchmarksgame](http://benchmarksgame.alioth.debian.org/u32/compare.php?lang=rust&lang2=gpp) shows that Rust is about as fast as C++. For some games
...
* [stackoverflow](http://stackoverflow.com/questions/tagged/rust?sort=votes&pageSize=50)
  has only 1781 questions of which 102 are unanswered (5.7%). C++ has 356,824
