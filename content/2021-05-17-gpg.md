...
*Learn what they are and how they are used*](../digital-signatures/)
...
uid                      John Smith <johnsmith@gmail.com>
...
pub   rsa4096 2021-05-16 [SC]
      20E4E524CA0B5402260F01EB62EE7851D92F3ECE
uid           [ultimate] John Smith <johnsmith@gmail.com>
sub   rsa4096 2021-05-16 [E]
```
...
Losing your private key is a shame. Now you need to share a new public key in a secure
...
```text
$ gpg --auto-key-locate keyserver --locate-keys john@smith.com
```
...
This produces a binary file called `signed-message.sig`. It contains the (compressed)
message and the signature. You can extract and verify it with:

```text
$ gpg --output destination.path.txt --decrypt signed-message.sig
gpg: Signature made So 16 Mai 2021 17:26:56 CEST
gpg:                using RSA key D1E632346B642680EF360D696901E782EF663EC4
gpg: Good signature from "Martin Thoma (Generated on 2021-01-15 for private use) <info@martin-thoma.de>" [ultimate]
```
...
```text
$ gpg --clearsign my-special-message.txt
```
...
To verify the clearsigned `message.txt.asc`, run:
...
uid           [ revoked] John Smith <john.smith@example.com>
```
