...
<table>
    ...
    <tr>
        <td><img src="../images/2018/09/wasching-bleach-not.png" alt="Do not bleach." /></td>
    ...
    <tr>
        ...
        <td><img src="../images/2018/09/wasching-chemicals-p.png" alt="Dry clean, any solvent except trichloroethylene" /></td>
    </tr>
    <tr>
        <td>No chemicals</td>
        <td>Professional cleaning</td>
        <td>Dry clean, hydrocarbon solvent only (HCS)</td>
        <td>Dry clean, any solvent except trichloroethylene</td>
    </tr>
</table>
