...
* **Security**: Almost all things in there were no issue at all if anybody sees
  them, but some I would prefer to stay private. So I need to make sure that
  the overall system is safe.
* **Stability**: Can I keep this thing running? What happens if my provider
  ...
  client (might have been lacking knowledge; I don't remember)
* **Media**
...
During the migration I've also realized that this wiki has a big overlap with my
blog. Only that I can very easily see the contents of my blog. And a lot of the
content was super outdated or even ridiculous. For example, I listed a lot of
...
YouTube, in contrast, was almost always unavailable. So much for "the
...
If you want to run the website on AWS, you have to pay for at least one EC2 instance.
