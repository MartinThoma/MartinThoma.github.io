...
* **Screen size**: How far away from the monitor are you? How much space do you have?
...
* Brightness in cd/m<sup>2</sup>: The brighter, the easier you can see things in sunlight
...
* Connectors: I expect HDMI. The rest is a plus. See my post on <a href="../video-display-interfaces/">Video display interfaces</a>.
...
<table>
    ...
    <tr>
        <td>Variable synchronization</td>
        <td></td>
        <td>Adaptive Sync/&#8203;AMD FreeSync, 40-144Hz (DisplayPort), with LFC support, without HDR, NVIDIA G-Sync Compatible (source: NVIDIA)</td>
        <td></td>
    </tr>
    <tr>
...
<table>
    <tr>
        ...
        <th><a href="https://en.wikipedia.org/wiki/Liquid-crystal_display#Vertical_alignment_(VA)"><abbr title="Vertical Alignment">VA</abbr></a></th>
...
**TL;DR**: IPS for work, TN for gaming, VA if you like Samsung and are willing
to pay more.
...
* L27m-28: 27 inch, Full HD resolution of 1920 x 1080, black
