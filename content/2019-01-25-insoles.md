...
we choose shoes by length, feet also differ in width, height, and the area which
touches the floor when standing on a flat surface. Insoles can
...
I tried the currex EdgePro one for a week or so, but my calves began to hurt.
...
Profile heights (arch support) are measured without weight by [Frugal Foot](https://www.youtube.com/watch?v=iXZuqAq42Mk):

* Green: Original, most popular, for high arches
* merinoGrey: Green one covered by merino wool
...
* hotPink: 2.0cm profile height, women-specific (narrower), foil lining at forefoot to make it warmer
