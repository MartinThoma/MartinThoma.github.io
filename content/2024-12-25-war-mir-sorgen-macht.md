...
Der Rückgang der Kohleförderung und die Krise der Stahlindustrie haben im
...
* Deutschland als unzuverlässiger Partner (2024): Wir verhalten uns weder intern
  ...
  Risiko eingehen. Wer weiß schon, was (politisch) morgen gilt.
    ...
    * Wärmepumpen: Die BILD-Zeitung hat in vielen Artikeln gegen Wärmepumpen
      ...
      CO2-Preis steigen. Das bedeutet, dass Leute, die sich jetzt eine neue
...
werden, wie man sie nicht einlösen muss. Ein Beispiel ist "Mehr Geld für das
Gesundheitssystem (NHS) durch den Brexit". Oder "Steuersenkungen ohne Einsparungen und ohne
neue Schulden".
...
* [Gegen Corona-Impfungen waren sie auch](https://afdsachsen.de/stopp-der-corona-impfung-jetzt/)
...
sowie den Krieg zwischen Russland und der Ukraine und die von der EU verhängten
Sanktionen gestört.
...
* **Strukturwandel durch Automatisierung**: ChatGPT hat eindrucksvoll gezeigt, dass Rechercheaufgaben
  von Software übernommen werden können. Wir werden in den nächsten Jahren
