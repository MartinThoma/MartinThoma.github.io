...
the neurons of the brain" (source: [Wikipedia](https://en.wikipedia.org/wiki/Electroencephalography)).

I'm really curious about this, because I recently had some thoughts that
medicine is currently not working the way I want it to. Doctors rely on the
information they get from their patients, and they shouldn't. Patients can
either directly lie or say something which is not true by accident. Instead of
taking this feedback from patients, decisions should more often rely on hard
data.

For locked-in people, that means people who have severe difficulties to
...
Another use I would really be curious about is some kind of "automatic
...
What I would expect from it is to be able to differentiate at least five
different kinds of signals which I can willingly make. Why five?
...
other (independent) people writing reviews about it. Preferably mentioning it
...
* [github.com/OpenBCI/Ultracortex](https://github.com/OpenBCI/Ultracortex):
  Instructions on how to assemble the Ultracortex Mark&nbsp;1 - Mark&nbsp;3
