...
![Four steps: attacker posts a script as a comment, the server stores it, a victim loads the page, the script sends the victim's cookie to the attacker](../images/2020/10/xss-stored-cookie-theft.svg)*A stored XSS attack that steals a session cookie. Image by Martin Thoma*
