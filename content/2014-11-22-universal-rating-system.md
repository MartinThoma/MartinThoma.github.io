...
tags: Idea, Internet, Community
featured_image: logos/star.png
---
A key feature of Amazon is its rating system. Rating systems are relatively
straightforward to build, but they need a lot of data and get better with more
data. I think Amazon builds a monopoly that way. However, I also think we
could build a Universal Rating System (URS).

Just as important as pure ratings are reviews.


## What would a URS need?

Directly necessary are:
...
* **Identification of people**: The same person should not be able to write
  ...
  think it would be good if it was possible to keep users anonymous while making
  sure that everybody has only one online identity.
* **Identification of products**: Users have to be able to find products and
  they have to find reviews of that product. So some kind of product
...
* **Recommendations**: If users see that they get good recommendations from
  an independent source, they might use the system. If they see that those
  recommendations improve with more reviews and more ratings, they will add more
...
* **Right incentives**: Having a great community is much about giving the right
  incentives. Badges and karma are a great way to do so, as
  Stack Exchange shows.

Non-software parts:

* **Advertisement**: People have to get informed about such a system.
* **Organization**: The software should be open source, the data should be
