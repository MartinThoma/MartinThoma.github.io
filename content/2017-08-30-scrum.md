...
---
Scrum is a software development framework. In contrast to the [waterfall model](https://en.wikipedia.org/wiki/Waterfall_model)
it is agile, meaning it is flexible and iterative. Other agile design processes are Extreme programming (XP) and
...
<dl>
    ...
    <dd>Subset of the product backlog that gets handled in the current sprint.
        Each user story's work gets estimated in points.</dd>
</dl>
