...
tags: Reinforcement Learning, Python, Machine Learning, AI
...
<table class="table">
    ...
    <tr>
        ...
        <td>discrete</td>
        <td><a href="http://incompleteideas.net/sutton/book/the-book-2nd.html"><abbr title="Reinforcement learning: An introduction">Sutton and Barto, 2011</abbr></a>, <a href="../probabilistische-planung/#sarsa">Blog Post</a></td>
    </tr>
    <tr>
...
<dl>
    ...
    <dt>SARSA</dt>
    <dd>Initialize the Q-Function $Q: \mathcal{X} \times \mathcal{A} \rightarrow \mathbb{R}$ randomly, adjust it over time. See <a href="../probabilistische-planung/#sarsa">Pseudocode</a></dd>
    <dt>DDPG</dt>
    <dd>?</dd>
    <dt>NAF</dt>
    <dd>?</dd>
...
The [`CartPole-v0`](https://gym.openai.com/envs/CartPole-v0/) environment has
2 actions: move the cart to the right or to the left. A reward of +1 is given
if the pole is upright. The episode is finished when the pole is more than
...
* Most environments have a continuous observation space and a discrete action space
