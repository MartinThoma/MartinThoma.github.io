...
<dl>
    ...
    <dt>SARSA</dt>
    <dd>Initialize the Q-Function $Q: \mathcal{X} \times \mathcal{A} \rightarrow \mathbb{R}$ randomly, adjust it by time. See [Pseudocode](../probabilistische-planung/#sarsa)</dd>
    <dt>DDPG</dt>
    <dd>?</dd>
    <dt>NAF</dt>
    <dd>?</dd>
