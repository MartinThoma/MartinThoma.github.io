...
tags: Klausur, Machine Learning, University, AI
...
<dl>
  ...
  <dd>Bei der Lokalisierung mobiler Agenten in einem Raum mit 4&nbsp;Wänden
      ...
      wobei $W^{-1}$ eine symmetrische, positiv definite Gewichtungsmatrix ist.
      </dd>
   ...
   <dd>Wenn bereits einmal die beste Ebene bestimmt wurde will man nicht wieder
       ...
       Bei uns mit vektorwertigen Sensoren, nicht wie im Skript mit
       Skalaren.</dd>
</dl>
...
<dl>
    <dt><a href="https://de.wikipedia.org/wiki/Simultaneous_Localization_and_Mapping"><dfn id="slam">SLAM</dfn></a> (<dfn>Simultaneous Localization and Mapping</dfn>)</dt>
    <dd>SLAM ist ein Algorithmus, welcher zugleich eine Karte erstellt und
        ...
        <ul>
            ...
            <li>Nichtlinearitäten des Problems</li>
        </ul>
    </dd>
    ...
    <dd>
        ...
        wobei $A_k$ Jacobi-Matrix von $a_k(x_k, u_k)$ für festes $u_k$ an der
        ...
        $$y_k = H_k(x_k) + v_k,$$
        wobei $H_k$ die Jacobi-Matrix von $h(x_k)$ an der Stelle $\hat{x}_k^P$
        ist.
    </dd>
    ...
    <dd>
        ...
        <u>Ansatz</u>: Sample aus Transitionsdichte
