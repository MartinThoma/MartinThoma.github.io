...
<figure>
    <a href="../images/2020/09/twitter-preview-crop.svg"><img src="../images/2020/09/twitter-preview-crop.svg" alt="A tall image with two people; a saliency model picks one crop, so the preview shows only one of them" width="680" height="350"></a>
    <figcaption>A preview cannot show everything, so a model decides what gets left out. Image by Martin Thoma</figcaption>
</figure>
...
* Jiayuan Huang, Alexander J. Smola, Arthur Gretton, Karsten M. Borgwardt, Bernhard Schölkopf: [Correcting Sample Selection Bias by Unlabeled Data](https://papers.nips.cc/paper/3075-correcting-sample-selection-bias-by-unlabeled-data.pdf)
