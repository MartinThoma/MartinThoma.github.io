...
category: Code
tags: Gunicorn, Flask, Python, Web Development
...
<table>
    ...
    <tr>
        <td>URL</td>
        <td></td>
        <td><a href="http://www.gevent.org/">gevent.org</a></td>
        <td><a href="https://eventlet.net/">eventlet.net</a></td>
        <td></td>
        <td><a href="https://aiohttp.readthedocs.io/en/stable/">aiohttp.readthedocs.io/en/stable</a></td>
        <td></td>
    </tr>
</table>
...
10,000 users, gevent gets slow. But the real difference was the 95th-percentile
...
* I didn't include Sanic, because it is less tested than Flask.[^2]
