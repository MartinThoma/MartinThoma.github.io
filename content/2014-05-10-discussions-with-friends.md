...
discussed, but rather share some thoughts about discussions.
...
* **Small Talk** is about being together and feeling fine. We do it when we are
  ...
  much about content, as talks about the weather, fashion or sitcoms show,
  although the amount of information you exchange varies quite a lot.
* **Feelings** and talking about feelings is difficult, but important. I tend
  to say it's like small talk, but I don't want to go into detail here.
* **Teaching** is a situation where one person knows more than another person
  about some topic and teaches it to the other.
* **Learning** is either the other side in the teaching situation or learning
  together. I think it is fundamentally different and deserves its own bullet
  ...
  It's a free flow of (hopefully) constructive thoughts with the aim of gaining
...
* **Moral or Political Discussions** are some sort of learning, but in contrast to learning in the
  ...
  to evaluate how to weigh those facts. Discussions involve a learning part,
...
* What should we do in situation ABC? What has to be considered and for what reasons?

But many of the conversations that are labeled as "discussions" feel rather
like small talk for the following reasons:

I think to have a meaningful discussion, you need to have a partner who does not
share your opinion. For political discussions, this means the following are NOT
meaningful statements:

* I want everybody to be able to find a job (or shorter: Fight unemployment)
* I want to make less debt
* I want everybody to be able to live a healthy life
* I want to help families
* I want everybody to be happy

All these statements are statements that everybody could agree with.
But you get reasonable statements when you tell how to do so.

You can also talk about the "order": I want to make less debt, but if young
families have to pay more than 20 Euro more per year, it is not acceptable.
Of course, that's still much too vague, but I think you get the point. Telling
...
the other - no matter how well he makes his point - convinces you of his opinion,
you're actually not having a discussion. You try to teach them. (And it's a
bad type of teaching.)

## Techniques to get the most out of discussions
...
to defend a point of view when we begin to defend it, no matter how well the other
...
or write very well. When you hear a new argument the first time, you might have
difficulties finding a correct counterargument. But when you're with friends,
...
an honest way to agree. It's a very bad step to fake agreement.

## Group dynamics

Always - and that's not only related to discussions - try to think what and how
the other thinks. Sometimes when a group discusses, a single person gets
...
* Try to support him when he has trouble finding the correct words or the
...
Changing opinions is difficult. Especially if you have had them for a long time or
...
So, what can we do to figure that out for ourselves? Sometimes it is impossible
to do so while discussing, but after the discussion you can think about it:

* What arguments did I give the others? How did I present them? What were the
  counterarguments? Are they valid? If so / not: Why?
...
If you're not sure about it, you can continue the discussion. It should not be a simple
repetition of arguments, but a new discussion with a new structure of arguments.
If you're still not sure after many arguments, you can make a pro / con list.
...
* Some arguments might be irrelevant. I tend to think "How does this impact my life?".
  ...
  might be irrelevant.
* You don't have to agree at the end. An honest disagreement where both sides
  understand the arguments of the other side is much better than a compromise
