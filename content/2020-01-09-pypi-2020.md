...
---
I've created an [introductory post](../analyzing-pypi-metadata/)
where I looked at the package metadata in a very superficial way.

In the [second post](../analyzing-pypi-metadata-2/), I
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>560</td>
            <td>128</td>
            <td><code>https://pypi.org/project/softwarefabrica.django.appserver/1.0dev-BZR-r10-panta-elasticworld.org-20091023132843-vitk6k7e5qlvhej5/</code></td>
        </tr>
        <tr>
            <td>package_url</td>
            <td>560</td>
...
<div class="gallery">
    <figure>
        <a href="../images/2020/01/pypi-imported-packages.png"><img src="../images/2020/01/pypi-imported-packages.png" alt="Weighted module imports by Python packages" width="512" height="464" loading="lazy"></a>
        <figcaption>Weighted module imports by Python packages</figcaption>
    </figure>
    <figure>
        <a href="../images/2020/01/pypi-imported-packages-count.png"><img src="../images/2020/01/pypi-imported-packages-count.png" alt="Module imports of Python packages" width="512" height="467" loading="lazy"></a>
        <figcaption>Module imports of Python packages</figcaption>
    </figure>
    <figure>
        <a href="../images/2020/01/pypi-imported-packages-excluding-system.png"><img src="../images/2020/01/pypi-imported-packages-excluding-system.png" alt="Module imports of Python packages, excluding system packages" width="512" height="471" loading="lazy"></a>
        <figcaption>Module imports of Python packages, excluding system packages</figcaption>
    </figure>
    <figure>
        <a href="../images/2020/01/pypi-imported-packages-excluding-system-count.png"><img src="../images/2020/01/pypi-imported-packages-excluding-system-count.png" alt="Module imports of Python modules excluding system modules" width="512" height="448" loading="lazy"></a>
        <figcaption>Module imports of Python modules excluding system modules</figcaption>
    </figure>
</div>
