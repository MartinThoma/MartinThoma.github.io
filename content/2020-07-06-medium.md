...
A big "Thank you" to [the contributors](../support-me/#contributions)!

In the cost list below, you can see that I lose about 66 EUR with my blog and
...
the prices and the exchange rate (USD ↔ EUR) change.
...
<table class="table">
    ...
    <tbody>
        <tr>
            <td><a href="../">martin-thoma.com</a></td>
            <td>14 EUR</td>
...
1. Tags
2. Images have to be downloaded separately
3. Source code is still in GitHub gists
...
seem to take a very rough glance at the articles.
...
On this blog, I can easily create beautifully syntax-highlighted code blocks
by just using the fenced code block notation of Markdown. On Medium, I have to
make a GitHub gist.

On this blog, I create mathematical formulas in a variety of different ways.
...
On this blog, I use [`blacken-docs`](https://github.com/asottile/blacken-docs)
