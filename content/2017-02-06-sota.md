...
Face detection is a special case of detection.

Common metrics are:
<ul>
    <li>mAP (Mean Average Precision): A detection is successful if the bounding
...
<table class="table">
    ...
    <tr>
        <td><abbr title="Wall Street Journal">WSJ</abbr> (eval92)</td>
        <td>2015</td>
        <td>3.47</td>
...
See [Word Error Rate](../word-error-rate-calculation/) (WER)
