...
between One-on-One tutoring and One-on-Many tutoring, where one tutor
...
It would be expensive if it were done the way tutoring is currently done. In fact, I
...
I could imagine it working like this: A student passes the exam, but he does
not have the grade he wants. As he has already passed the exam, he will not be
allowed to simply write it again. So he has to search for a student who hasn't
passed the exam yet and help this student to prepare for the exam. Now we have to
...
threshold of $\theta_1$.
$\theta_1$ should denote how many more points the student needs (in percent of
the points the students need) to get the possibility to re-do the exam.

$\theta_1 = 0$ would mean that the tutor only needs a student who
gets the minimum number of points to pass the exam.

$\theta_1 = 1$ would mean that the tutor needs his student to get twice as many
points in the exercises as he would need to be allowed to
...
$\theta_1$ must not be too high. The higher it gets, the more difficult and time-
...
good incentive for the student to keep working on exercises, even if he
...
difficult to get a student to achieve such good results.


## How to speak about it

I would like to call this model MOOT (Martin's One-on-One Tutoring model ☺ ).
...
the tutor could simply write the exercises himself. But I don't think that
would be a problem, because then the tutor would do the exercises. He would
still practice. We only get a problem if larger groups of students copy
exercises. I don't think that is the case, but I judge from the students I
know. I might have a biased view on the problem.


## Conclusion
The two ways I proposed would in general remove stress
from students because a single bad exam would not be that bad any more and
very likely lead to better students. Students would be better on paper
...
* Getting "exclusive" rights:
  ...
  * Getting access to equipment of the university (executing your personal
    ...
    use lecture halls)
* "Proud" of the university: If we could make KIT students proud of being
  students at KIT, they themselves might want to support fellow
  students.
