...
---
[Lynis](https://cisofy.com/documentation/lynis/get-started/) is an auditing tool.
...
[github.com/CISOfy/lynis/issues/213](https://github.com/CISOfy/lynis/issues/213)
...
The [lynis report of Ubuntu 18.04](../pdf/lynis-report.pdf) is super long.
...
Change `/etc/php/7.2/apache2/php.ini` (e.g. with `sublime`) to contain the following lines:
