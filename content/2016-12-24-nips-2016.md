...
main topic. This year, about 6000 people attended it. My friend Marvin and I
...
<figure>
    <a href="../images/2016/12/nips-2016-wordcloud.png"><img src="../images/2016/12/nips-2016-wordcloud.png" alt="Wordcloud of NIPS titles of 2016" width="800" height="512"></a>
</figure>
...
<figure>
    <a href="../images/2016/12/subject_areas_submitted1.png"><img src="../images/2016/12/subject_areas_submitted1.png" alt="NIPS 2016 areas submitted" width="1721" height="292" loading="lazy"></a>
</figure>
...
1. GANs
2. Reinforcement Learning: Look for "bandit" in the paper titles
...
Generative Adversarial Networks (short: GANs) were one hot topic at NIPS. The
...
<ul>
    ...
    <li><a href="https://papers.nips.cc/paper/6399-infogan-interpretable-representation-learning-by-information-maximizing-generative-adversarial-nets.pdf">InfoGAN</a>: Get more control over properties of the generated content.</li>
...
Combining deep learning with graphical models like CRFs / Markov Random Fields
...
I don't really know this area, so I leave it to [Eric Jang](http://blog.evjang.com/2017/01/nips2016.html)
...
* [MetaGrad: Multiple Learning Rates in Online Learning](https://papers.nips.cc/paper/6268-metagrad-multiple-learning-rates-in-online-learning)
    * [bitbucket.org/wmkoolen/metagrad](https://bitbucket.org/wmkoolen/metagrad)
...
* [Layer Normalization](https://arxiv.org/abs/1607.06450): A successor for Batch Normalization?
...
* [Measuring Neural Net Robustness with Constraints](https://arxiv.org/abs/1605.07262): Measure robustness against adversarial examples
...
* [Universal Correspondence Network](https://arxiv.org/pdf/1606.03558v3.pdf): Find semantically meaningful similar points in two images. For example, two frontal images of different humans, where the network finds eyes, nose, chin, lips in both images.
...
* YouTube:
    ...
    * Yann LeCun: [Energy-based GANs & other adversarial training](https://www.youtube.com/watch?v=88nKI-qqWEo)
