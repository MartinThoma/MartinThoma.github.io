...
This article is mostly a wish list. Things I would like to change in Germany,
...
<table>
    ...
    <tr>
        <td>6</td>
        <td>Payment of public broadcasting</td>
        <td><span style="color: red;">&#10071;</span></td>
        <td><span style="color: green;">&#10004;&#10004;&#10004;</span></td>
    </tr>
    <tr>
...
Getting around paying taxes in a way / amount which lawmakers did not anticipate
is a problem.
...
In Germany, people can opt out of public health insurance and use a private
insurance instead. This is a problem as they usually opt out because they would
otherwise pay more. And it is a problem as those people might be in need of it
later.

**The solution**: Don't allow opting out of public health insurance. I'm also not
...
a loan. Not to mention the additional paperwork it creates.
...
**The solution**: Make a website. The Swedes do it pretty well 🙂


### Declare Place of Residency

You have to declare where you live. When you move within Germany, you have to
...
> The software of this router / smartphone / smartwatch will expire in 2019-01.

Better would be at least 2 years of guaranteed updates - if a critical bug is
...
be to force companies to publish their source code in case of bankruptcy.


### Pay of politicians

The pay (German: "Diäten") of Germany's
members of parliament is set by the parliament. This is a constant reason for
rage for people who earn very little. "While their situation gets worse, the
politicians put the money in their pockets" or similar thoughts.
...
of working people in Germany. This would be roughly equal to the amount they get
...
the gross income of the lowest-earning 10% was 1201 EUR. So if we would like to
connect the ambitions of MPs more to the poorer parts of the population, we
could give them 8.3× the income of the 10th percentile.
...
* **Income Transparency**: Every member of parliament should have to make their
  ...
  having to pay back the money plus a fine, losing pensions, and prison time.
* **Lobby Register**: See details <a href="https://www.abgeordnetenwatch.de/lobbyregister-jetzt">here</a>.
...
effective treatment and use the scam instead ([example](https://twitter.com/drluebbers/status/1388037368033255425)).
...
* This product did not prove effectiveness.
