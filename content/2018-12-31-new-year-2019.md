...
* I wrote only 48&nbsp;articles for this blog (including this one, not counting 13 which were published yesterday) in 2018. A couple
  of them might be interesting:
      * [Nepal](../nepal/)
      * [Datetime](../datetime/) - or even better my short summary [What every developer should know about time](https://zenodo.org/record/1443533)
      * A couple about details in Python such as [packaging](../python-projects/), [str vs repr](../str-vs-repr/), [property](../python-property/), [testing](../testing-python-code/), [style guide](../python-style-guide/)
      * A couple of shorter data science related ones, such as an [overview](../data-science/), a [project guide](../ds-project-guide/), the problems of [Feature Importance](../feature-importance/), [time series forecasting](../forecasting/)
      * Only [one recipe](../bala-bala/)!
* I've uploaded 195&nbsp;files to Wikimedia Commons in 2018 (2164 files in total, <a href="http://tools.wmflabs.org/ptools/uploadsum.php?user=MartinThoma">source</a>). My uploads to Wikimedia Commons
...
Overall, I have to say that I spent a lot of time working. Maybe too much
time. I've noticed that I contributed a lot less to Wikipedia, wrote fewer blog
...
* <span style="color:green;">&#x2714;</span> Visiting a new country - I've been to the [Czech Republic](../prague/)
...
* <span style="color:green;font-weight:bold;">✓</span> Deleting several hundred e-mails (over 500 unread e-mails, 824 starred e-mails)
...
1. TensorFlow will keep being the dominant deep learning framework as measured
   by (1) StackOverflow questions, (2) Google Trends, (3) GitHub repositories
...
3. We will see fraud cases related to ML (e.g. using speech synthesis for identity theft or tricking an ML system).
...
10. <span style="color:green;" title="Impeachment started, but he is still in office">&#x2714;</span> Trump will still be in office
