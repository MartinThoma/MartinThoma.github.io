...
I recommend having a look at [busliniensuche.de](https://www.busliniensuche.de)
...
* For the bus trip (for one person):
    ...
    * 4 slices of bread (cheese and sausage)
    * 1 package of muesli bars
    * 1 package of disinfecting tissues
    * 3 packages of tissues
* Organization
    * Tickets for the journey (both: to Prague and back)
...
It was super hard to [get CZK](../foreign-money/) in Munich with Sparkasse. I went to Marienplatz
...
For N26, withdrawing another currency seems to be free ([source](https://docs.n26.com/legal/bank-account/de/n26-016-preisliste-de.pdf))? Let's see...
...
* [Prague Castle](https://goo.gl/maps/YbDd64d1V7U2)
* [Prague astronomical clock](https://goo.gl/maps/PnNbSkNZt592)
