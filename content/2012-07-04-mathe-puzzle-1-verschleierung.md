...
Schreiben wir das doch mal um. Wenn wir schon die normale Addition bzw. Subtraktion des Körpers $\mathbb{R}$ benutzen, können wir auch die gewohnten Symbole verwenden:
$O:\mathbb{N} \rightarrow \mathbb{R}$
$O(0) := 0, O(0^0) := 0^0, O(o) := O(o - 0^0) + O(o - 0^0 - 0^0)$

Nun sind wir es gewohnt, dass die Funktionen $f$ heißen und die Variablen x:
