...
You might also want to read the <a href="https://wiki.archlinux.org/index.php/Installation_Guide">Arch Linux Installation Guide</a>. The <a href="https://wiki.archlinux.de/title/Anleitung_für_Einsteiger">German guide</a> is also very good.
...
Uncomment your language (from now on, your prompt should be "sh-4.2#").
