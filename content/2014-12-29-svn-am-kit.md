...
tags: KIT, Version Control, SWT I, University
featured_image:
---
...
```bash
svn copy mySourceFile.java folder/myDestFile.java
```
...
<strong>Delete</strong> (<a href="http://svnbook.red-bean.com/en/1.7/svn.ref.svn.c.delete.html">Hilfe</a>):
...
Anders als der Standard-<a href="http://linux.die.net/man/1/rm">rm-Befehl</a> von Linux ist der von SVN rekursiv!
