...
category: Code
tags: PHP, Web Development, Database
...
<h2>Usage</h2>
I took a small [chess database](../community-chess/) to test this package. You can set it up with <a href="http://code.google.com/p/community-chess/source/browse/trunk/install/chess.sql?spec=svn99&r=98">this sql file</a>.

It's sad, but only including <strong>MDB2.php</strong> shows 5 "Deprecated"-messages and 6 warnings because of "Strict Standards".
...
MDB2 offers lots of other features like choosing a (non)persistent connection, prepared statements or debugging option. If you're interested in PEAR MDB2 I recommend to take a look at installationwiki.org.
