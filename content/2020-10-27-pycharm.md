...
---
<figure>
    <a href="../images/2020/10/pycharm-1.png"><img src="../images/2020/10/pycharm-1.png" alt="PyCharm Professional 2020.2. The screenshot was taken by Martin Thoma." width="1920" height="1029"></a>
    <figcaption>PyCharm Professional 2020.2. The screenshot was taken by Martin Thoma.</figcaption>
</figure>
...
<figure>
    <a href="../images/2020/10/pycharm-2.png"><img src="../images/2020/10/pycharm-2.png" alt="The screenshot was taken by Martin Thoma" width="987" height="347" loading="lazy"></a>
    <figcaption>The screenshot was taken by Martin Thoma</figcaption>
</figure>
...
<figure>
    <a href="../images/2020/10/pycharm-3.png"><img src="../images/2020/10/pycharm-3.png" alt="The screenshot was taken by the author." width="855" height="417" loading="lazy"></a>
...
<figure>
    <a href="../images/2020/10/pycharm-4.png"><img src="../images/2020/10/pycharm-4.png" alt="PyCharm automatically suggests using one of the attributes of the used class. The screenshot was taken by the author." width="802" height="208" loading="lazy"></a>
    <figcaption>PyCharm automatically suggests using one of the attributes of the used class. The screenshot was taken by the author.</figcaption>
</figure>

PyCharm also gives you hints when you create a new class or use a function:

<figure>
    <a href="../images/2020/10/pycharm-5.png"><img src="../images/2020/10/pycharm-5.png" alt="PyCharm tells you that there are two parameters — x and y — expected. It also lets you know that you have to enter the first one now (x is bold) and that it should be a float 😍" width="228" height="97" loading="lazy"></a>
    <figcaption>PyCharm tells you that there are two parameters — x and y — expected. It also lets you know that you have to enter the first one now (x is bold) and that it should be a float 😍</figcaption>
</figure>
...
<figure>
    <a href="../images/2020/10/pycharm-6.png"><img src="../images/2020/10/pycharm-6.png" alt="The debugger of PyCharm. Screenshot was taken by Martin Thoma." width="1894" height="956" loading="lazy"></a>
    <figcaption>The debugger of PyCharm. Screenshot was taken by Martin Thoma.</figcaption>
</figure>
...
<figure>
    <a href="../images/2020/10/pycharm-7.png"><img src="../images/2020/10/pycharm-7.png" alt="Code Inspection within PyCharm." width="957" height="554" loading="lazy"></a>
    <figcaption>Code Inspection within PyCharm.</figcaption>
</figure>
