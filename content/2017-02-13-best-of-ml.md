...
* [Warning Signs in Experimental Design and Interpretation](http://norvig.com/experiment-design.html): Not the typical ML literature, but interesting and relevant nonetheless as ML is driven by experiments.
...
* [Machine Learning](https://www.cs.ox.ac.uk/people/nando.defreitas/machinelearning/): Course by the University of Oxford
* [Convolutional Neural Networks for Visual Recognition](http://cs231n.stanford.edu/): Course by Stanford
...
* [IRIS](https://archive.ics.uci.edu/ml/datasets/Iris): 3 classes, 50 items per class, 4 features per item
...
* [computervisiononline.com](http://www.computervisiononline.com/datasets): A list of many datasets
