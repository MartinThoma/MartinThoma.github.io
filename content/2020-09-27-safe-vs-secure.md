...
* **Availability**: A single server could be cut off from the internet by
...
* **Scalability**: Web services might go down when they are too successful.
  ...
  campaign.
* **Integrity**: All ways to send data are prone to errors. Packet loss or
...
A defect there can put lives at risk
...
life-support systems, software managing the electrical power grid, industrial
...
* **Integrity**: Think of a bank account. An attacker wants to increase the
  ...
  is an example where not the data but the software is affected.
...
* [IEEE Std 1228](https://ieeexplore.ieee.org/document/467427): “Standard for Software Safety Plans”.
* OmniSecu: [Types of Network Attacks against Confidentiality, Integrity and Availability](https://www.omnisecu.com/ccna-security/types-of-network-attacks.php)
