...
The last year has had its ups and downs. Most of them are private, so I'll not
...
(Sommerakademie der Studienstiftung, see [photos](https://commons.wikimedia.org/wiki/Category:Images_by_Martin_Thoma/Sommerakademie-2015)) and I've been hiking the West Highland Way for two weeks
...
* I've got funding from the [Begabtenstiftung](http://www.begabtenstiftung-informatik.de/)
...
These were several hundred emails.
...
Clean those folders up ... \*sigh\*... I didn't finish.
...
* <span style="color:green;">&#x2714;</span> Quit church: That one is actually more complicated in Germany than it
  should be. I have to get to the civil registry office, get a **personal**
  appointment, **pay 31.50 Euro**
  (Source: [karlsruhe.de](https://web1.karlsruhe.de/service/d115/detail.php?prod_id=463))
* <span style="color:green;">&#x2714;</span> Migrate from [Jekyll](https://jekyllrb.com/) to [Pelican](http://docs.getpelican.com/) (see [article draft](https://github.com/MartinThoma/MartinThoma.github.io/blob/source/_drafts/2015-11-13-migrate-from-jekyll-to-pelican.md))
* [ ] Get all my stuff from my father's apartment to my room. I've already
      packed most of it in boxes (In total: 1.30m (+0.30m?) × 0.39m × 0.60m by 7 boxes)
* <span style="color:green;">&#x2714;</span> Get rid of my old bed
* <span style="color:green;">&#x2714;</span> Get rid of my old vacuum cleaner
* <span style="color:green;">&#x2714;</span> Paint the wall
* <span style="color:green;">&#x2714;</span> Contact BSI, BKA, CCC and the car
  sellers and send them my paper in which I summarize current problems in car
  security.
* [ ] Get new slippers

Of course, I have a lot of other plans. Although some people say I don't do
anything besides computer stuff, I do have a private life. But in contrast to
...
1. Networks will get deeper. Currently about 8&nbsp;layers are usual; I expect
...
3. Machines will generate "high" resolution images of at least 256 &times; 256
   pixels.
4. Speech synthesis will improve rapidly. To benchmark this, I will use the
   original quotation that explains the importance of towels, which is found in
   Chapter 3 of Adams' work The Hitchhiker's Guide to the
   Galaxy. See [Towel Day](https://en.wikipedia.org/wiki/Towel_Day), [Google Translate Recording](../audio/2016-01-04-towel-quote-google.ogg), [Festival Recording](../audio/2016-01-04-towel-quote-festival.ogg)
...
9. I will publish at least 40&nbsp;articles on my blog.
10. I will get a 90&nbsp;day streak on GitHub (currently, my longest is
   43&nbsp;days).
...
14. The Republican candidate will become president.
