...
<figure>
    <a href="../images/2012/12/eclipse-juno-loading-300x200.png"><img src="../images/2012/12/eclipse-juno-loading-300x200.png" alt="Eclipse Juno loading screen" width="300" height="200"></a>
    <figcaption>Eclipse Juno loading screen</figcaption>
</figure>

Visual Studio 2012 takes 1 minute and 15 seconds to start:
<figure>
    <a href="../images/2012/12/visual-studio-2012-loading-229x300.png"><img src="../images/2012/12/visual-studio-2012-loading-229x300.png" alt="Visual Studio Ultimate - Loading screen" width="229" height="300" loading="lazy"></a>
    <figcaption>Visual Studio Ultimate - Loading screen</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/visual-studio-2012-loading-times-300x202.png"><img src="../images/2012/12/visual-studio-2012-loading-times-300x202.png" alt="Visual Studio 2012 - loading something without any action from my side" width="300" height="202" loading="lazy"></a>
    <figcaption>Visual Studio 2012 - loading something without any action from my side</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/CWindowssystem32cmd-300x204.png"><img src="../images/2012/12/CWindowssystem32cmd-300x204.png" alt="Windows32 cmd" width="300" height="204" loading="lazy"></a>
    <figcaption>Windows32 cmd</figcaption>
</figure>

<figure>
    <a href="../images/2012/12/WindowsPowerShellv1.0-300x231.png"><img src="../images/2012/12/WindowsPowerShellv1.0-300x231.png" alt="Windows PowerShell v1.0" width="300" height="231" loading="lazy"></a>
    <figcaption>Windows PowerShell v1.0</figcaption>
</figure>

Now compare this to Linux:

<figure>
    <a href="../images/2012/12/gnome-shell-300x117.png"><img src="../images/2012/12/gnome-shell-300x117.png" alt="Gnome shell (bash)" width="300" height="117" loading="lazy"></a>
    <figcaption>Gnome shell (bash)</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/windows-right-click-287x300.png"><img src="../images/2012/12/windows-right-click-287x300.png" alt="Windows right click menu" width="287" height="300" loading="lazy"></a>
    <figcaption>Windows right click menu</figcaption>
</figure>

Now compare this to Linux 10.04 with GNOME:
<figure>
    <a href="../images/2012/12/gnome-2-right-click-300x292.png"><img src="../images/2012/12/gnome-2-right-click-300x292.png" alt="Right click menu on GNOME 2" width="300" height="292" loading="lazy"></a>
    <figcaption>Right click menu on GNOME 2</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/shutdown-windows.png"><img src="../images/2012/12/shutdown-windows.png" alt="Automatic shutdown of Windows" width="426" height="362" loading="lazy"></a>
    <figcaption>Automatic shutdown of Windows</figcaption>
</figure>

<figure>
    <a href="../images/2012/12/windows-7-automatic-update-installation-300x225.jpg"><img src="../images/2012/12/windows-7-automatic-update-installation-300x225.jpg" alt="Windows 7: Automatic update installation" width="300" height="225" loading="lazy"></a>
    <figcaption>Windows 7: Automatic update installation</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/windows-start-search-240x300.png"><img src="../images/2012/12/windows-start-search-240x300.png" alt="Windows Start search" width="240" height="300" loading="lazy"></a>
    <figcaption>Windows Start search</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/microsoft-owa-300x157.png"><img src="../images/2012/12/microsoft-owa-300x157.png" alt="Microsoft OWA" width="300" height="157" loading="lazy"></a>
    <figcaption>Microsoft OWA</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/usb-mouse-windows-7-300x101.png"><img src="../images/2012/12/usb-mouse-windows-7-300x101.png" alt="Installing USB mouse in Windows 7" width="300" height="101" loading="lazy"></a>
    <figcaption>Installing USB mouse in Windows 7</figcaption>
</figure>
...
<h3>Structure</h3>
<figure>
    <a href="../images/2012/12/windows-7-explorer-300x220.png"><img src="../images/2012/12/windows-7-explorer-300x220.png" alt="Windows 7 Explorer" width="300" height="220" loading="lazy"></a>
    <figcaption>Windows 7 Explorer</figcaption>
</figure>
...
<figure>
    <a href="../images/2012/12/full-screen-terminal-300x169.png"><img src="../images/2012/12/full-screen-terminal-300x169.png" alt="Windows Terminal in 'Full Screen'" width="300" height="169" loading="lazy"></a>
    <figcaption>Windows Terminal in 'Full Screen'</figcaption>
</figure>
