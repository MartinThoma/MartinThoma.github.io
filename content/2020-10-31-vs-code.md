...
---
![Visual Studio Code 1.50.1. The screenshot was taken by Martin Thoma.](../images/2020/10/visual-studio-code-1.jpg)*Visual Studio Code 1.50.1. The screenshot was taken by Martin Thoma.*
...
![Screenshot was taken by the author](../images/2020/10/visual-studio-code-2.png)*Screenshot was taken by the author*
...
![The shortcut editor of VS Code. Screenshot was taken by the author.](../images/2020/10/visual-studio-code-3.png)*The shortcut editor of VS Code. Screenshot was taken by the author.*
...
![Autocompletion example of VS Code with pylance. Screenshot was taken by the author.](../images/2020/10/visual-studio-code-4.png)*Autocompletion example of VS Code with pylance. Screenshot was taken by the author.*
...
![The function signature hint when you hover over the name. Screenshot was taken by the author.](../images/2020/10/visual-studio-code-5.png)*The function signature hint when you hover over the name. Screenshot was taken by the author.*
...
![Screenshot was taken by the author](../images/2020/10/visual-studio-code-6.jpg)*Screenshot was taken by the author*
...
![Dark and light themes, including Solarized and TextMate 😍 Screenshot was taken by the author.](../images/2020/10/visual-studio-code-7.png)*Dark and light themes, including Solarized and TextMate 😍 Screenshot was taken by the author.*

### Settings

![Screenshot was taken by the author](../images/2020/10/visual-studio-code-8.png)*Screenshot was taken by the author*
...
![I had to enable the “basic” type checking mode for pylance in the user settings (`Ctrl` + `Shift` + `P`). Screenshot was taken by the author.](../images/2020/10/visual-studio-code-9.png)*I had to enable the “basic” type checking mode for pylance in the user settings (`Ctrl` + `Shift` + `P`). Screenshot was taken by the author.*

### Rainbow Brackets

[Rainbow brackets](https://marketplace.visualstudio.com/items?itemName=2gua.rainbow-brackets) colors nested brackets:

![It’s easier to read with colored brackets, isn’t it?](../images/2020/10/visual-studio-code-10.png)*It’s easier to read with colored brackets, isn’t it?*
...
![Screenshot was taken by the author](../images/2020/10/visual-studio-code-11.png)*Screenshot was taken by the author*

### GitLens

[GitLens](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens) shows you information about the git history:

![Do you notice the gray text? That is the name of the editor (me), when the edit was done and the first line of the commit message. Screenshot was taken by the author](../images/2020/10/visual-studio-code-12.png)*Do you notice the gray text? That is the name of the editor (me), when the edit was done and the first line of the commit message. Screenshot was taken by the author*

If you hover over the message, you can jump to the commit which opens a graphical diff 😍

![A graphical diff of the commit highlighted before. Screenshot was taken by the author.](../images/2020/10/visual-studio-code-13.jpg)*A graphical diff of the commit highlighted before. Screenshot was taken by the author.*
...
![The screenshot was taken by the author](../images/2020/10/visual-studio-code-14.png)*The screenshot was taken by the author*
