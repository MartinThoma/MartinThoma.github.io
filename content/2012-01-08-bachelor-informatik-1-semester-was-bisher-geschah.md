...
tags: Computer Science, Mathematics, KIT, University
...
<ul>
  ...
  <li><strong>Funktionen</strong>: Grenzwerte, Häufungspunkte, <a href="http://de.wikipedia.org/wiki/Stetigkeit">Stetigkeit</a>, abgeschlossen, offen, <a href="http://de.wikipedia.org/wiki/Gleichm%C3%A4%C3%9Fige_Konvergenz">gleichmäßige Konvergenz</a>, <a href="http://de.wikipedia.org/wiki/Gleichm%C3%A4%C3%9Fige_Stetigkeit">gleichmäßige Stetigkeit</a>, <a href="http://de.wikipedia.org/wiki/Lipschitz-Stetigkeit">Lipschitz-Stetigkeit</a></li>
</ul>

<h4>Sätze</h4>
<ul>
  <li><a href="http://de.wikipedia.org/wiki/Satz_von_Bolzano-Weierstra%C3%9F">Satz von Bolzano-Weierstraß</a></li>
...
<ul>
  <li><a href="http://de.wikipedia.org/wiki/Gruppentheorie">Gruppen</a>:
    <ul>
      ...
      <li>Beispiele: alle Ringe und Körper</li>
    </ul>
  </li>
  <li><a href="http://de.wikipedia.org/wiki/Ringtheorie">Ringe</a>:
    <ul>
      ...
      <li>Beispiele: alle Körper</li>
      <li>Gegenbeispiele: $(\mathbb{N}, +, \cdot)$</li>
    </ul>
  </li>
  <li><a href="http://de.wikipedia.org/wiki/K%C3%B6rper_(Algebra)">Körper</a>:
    <ul>
  ...
  <li><a href="http://de.wikipedia.org/wiki/Vektorraum">Vektorräume</a>:
    <ul>
...
<h4>Algorithmen</h4>
<ul>
  <li><a href="http://de.wikipedia.org/wiki/Gau%C3%9Fsches_Eliminationsverfahren">Gaußsches Eliminationsverfahren</a>:
  <ul>
    <li>Was bedeuten Nullzeilen?</li>
    <li>Wann hat das LGS keine / eine / viele Lösungen?</li>
...
<ul>
  ...
  <li><a href="http://de.wikipedia.org/wiki/Baum_(Graphentheorie)">Baum</a>, <a href="http://de.wikipedia.org/wiki/Wurzel_(Graphentheorie)">Wurzel</a>, <a href="http://de.wikipedia.org/wiki/Bin%C3%A4rbaum">Binärbaum</a></li>
...
<ul>
  ...
  <li><a href="http://de.wikipedia.org/wiki/Regul%C3%A4re_Sprache">Reguläre Sprachen</a>: Alle von einem DEA erkannten Sprachen.</li>
  <li><a href="../pumping-lemma/" title="Beweis durch Widerspruch: Eine Sprache ist nicht regulär (Pumping-Lemma)">Pumping-Lemma</a></li>
  ...
  <li>Approximationen, Approximationsgüte</li>
</ul>

<h4>Komplexitätsklassen</h4>
<ul>
  ...
  <li><a href="http://de.wikipedia.org/wiki/P-NP-Problem">P vs. NP</a>: Wie könnte es bewiesen / wiederlegt werden?</li>
