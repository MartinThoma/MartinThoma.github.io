...
category: Code
tags: Python, Ansible, DevOps, IaC, Configuration Management, Continuous Delivery, Software Engineering
featured_image: logos/ansible.png
---
Ansible is a configuration management tool maintained by Red Hat. It has to be
installed on a control machine. On the target machine, no configuration is
...
physical machine. You don't need to own it / take care of the hardware, but
it needs to exist. Suppose you use Amazon's cloud AWS. Then you can use
