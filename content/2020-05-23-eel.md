...
category: Code
tags: Python, GUI, Electron, JavaScript
...
That one is a bit too long to paste here completely, mainly due to the logic of write-math.
...
* [Stack Overflow 'eel'](https://stackoverflow.com/questions/tagged/eel?tab=Votes)
