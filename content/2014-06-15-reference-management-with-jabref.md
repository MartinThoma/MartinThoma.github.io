...
---
Keeping track of papers, articles and books or, more generally, sources you can
...
I've tried to create an [MWE for biblatex](https://github.com/MartinThoma/LaTeX-examples/tree/master/documents/biblatex-mwe), but as I don't really know much about BibTeX it's probably not
...
is my bachelor's thesis (work is still in (slow) progress).
...
other people's BibTeX files to **complete the information** or to get informed of
...
it has started, it's ok.

**Shortcuts** are important for tools that get used often, too. Although
JabRef has some reasonable shortcuts like <kbd>Ctrl</kbd>+<kbd>i</kbd> for
importing a BibTeX file and <kbd>Ctrl</kbd>+<kbd>s</kbd> for saving the current
...
I would also like to "import" BibTeX data by copying and pasting a single dataset.
