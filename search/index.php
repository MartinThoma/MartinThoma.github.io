...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
  ...
  <head profile="http://gmpg.org/xfn/11">
    ...
    <title>Search</title>
    <link rel="stylesheet" href="http://martin-thoma.com/css/201401031850.min.css" type="text/css" media="screen" />
...
<ul>
    <li id="search">
        <div class="searchlayout">
            <form method="get" id="searchform" action="http://google.com/cse">
                <input type="hidden" name="cx" value="017345337424948206369:qrnnnentkkk" />
                <input type="text" value="Search with Google" 
