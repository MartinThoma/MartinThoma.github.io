...
{% caption align="aligncenter" width="300" caption="After having bought an audiobook" url="../images/2013/08/bought-audio-book-300x166.png" alt="After having bought an audiobook" text="After having bought an audiobook" height="166" class="size-medium wp-image-76101" %}

After clicking on "my library" I get to this page:

{% caption align="aligncenter" width="300" caption="My library" url="../images/2013/08/audible-my-library-300x168.png" alt="My library" text="My library" height="168" class="size-medium wp-image-76121" %}

A click on "Start Audible-Assistant" redirects to:

{% caption align="aligncenter" width="300" caption="Software download assistant" url="../images/2013/08/assistant-software-download-300x168.png" alt="Software download assistant" text="Software download assistant" height="168" class="size-medium wp-image-76131" %}
...
{% caption align="aligncenter" width="300" caption="Audible Manager" url="../images/2013/08/audible-manager-300x168.png" alt="Audible Manager" text="Audible Manager" height="168" class="size-medium wp-image-76171" %}
...
{% caption align="aligncenter" width="300" caption="Audible Web assistant" url="../images/2013/08/audible-assistant-300x168.png" alt="Audible Web assistant" text="Audible Web assistant" height="168" class="size-medium wp-image-76191" %}
