...
<tr>
<td>[text]checks if (globalVar > 0)
looping ... 
looping ... 
execute test.globalVar--;[/text]</td>
<td>[text].
...
[java]Compiled from "MyParallelClass.java"
...
[java]   30:	getstatic	#3; //Field test.globalVar:I
   33:	iconst_1
   34:	isub
   35:	putstatic	#3; //Field test.globalVar:I[/java]
