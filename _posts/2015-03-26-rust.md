...
~~You should also know that Rust is not in version 1.0. Things do change. And they change fast. Rust 1.0 final will be released by May 15, 2015 ([source](http://blog.rust-lang.org/2015/02/13/Final-1.0-timeline.html)).~~
