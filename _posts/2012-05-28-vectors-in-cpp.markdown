...
[cpp]// create a vector with 100 zeroes
vector<int> myVector (100);[/cpp]

[cpp]// create a vector which has 42 times the integer 100
vector<int> myVector (42, 100);[/cpp]
...
Output:
[bash]Inner vector: 1 2 
Inner vector: 3 
Inner vector: 
Inner vector: [/bash]

<h3>Initialize nested vectors</h3>
[cpp]vector<int> myInnerVector(5, 3);
vector<vector<int> > myVector(8,myInnerVector);[/cpp]
Output with the script above:
[bash]Inner vector: 3 3 3 3 3 
...
Inner vector: 3 3 3 3 3 
Inner vector: 3 3 3 3 3 
Inner vector: 3 3 3 3 3 [/bash]

You could also do it this way:
[cpp]vector< vector<int> > myVector(8, vector<int>(5, 3));[/cpp]
