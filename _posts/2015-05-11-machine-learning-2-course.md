...
<ul>
    ...
    <li>Wie lautet die Optimierungsformel der transductive SVM?
        → TODO</li>
    <li>Was macht man im Reinforcement Learning, wenn Aktionen länger dauern?
        → Options verwenden (TODO: Wie ändert sich die Value Iteration Formel
           nun bzgl. der Zeit?)</li>
    <li>Warum heißen POMDPs "Partially Observable"?
        → TODO</li>
    <li>Welche Active Learning Techniken gibt es?
        → Query / Selective / Pool-based (vgl. <a href="#tocAnchor-1-1-4">Query-by-Committee</a>)</li>
    <li>Wie nennt man ein instanziiertes OPRM?
        → TODO (Skelett?)</li>
    <li>Wie funktioniert aktives Lernen bei SVMs?
        → TODO (Laut Protokoll: Hypothesenraum verkleinern bis nur noch eine
                 Hypothese vorhanden ist, dann erhält man auch die optimale
                 Hypothese)</li>
    <li>Was versteht man unter Transduktivem Lernen?
        → TODO</li>
    <li>Was versteht man unter Transduktivem Lernen?
        → TODO</li>
    <li>Wie nennt man die Wahrscheinlichkeit des aktiellen Zustands in POMDPs?
        → Belief.</li>
</ul>

Alt zu sein scheinen Evolutionäre Algorithmen:
...
<ul>
    ...
    <li>Was sind die wichtigsten Elemente von evolutionären Algorithmen?
