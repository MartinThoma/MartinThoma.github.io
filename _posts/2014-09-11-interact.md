...
This article is still in progress. I will finish it tomorrow.
...
A first step is the application as described [here](http://interact.anthropomatik.kit.edu/120.php). A general contact person
is Margit Rödder.
...
remote busses in Germany where you don't have any place for yourself.
...
wanted to charge their phones, a laptop, two tables and a camera simultanously
...
animals in America. I don't think that mamals are very interesting, so that
was pretty boring for me.

It has some "Special Exhebitions" for which you have to pay in advance if
you want to be able to see them.
The "Dark Universe" special exhebition is probably not worth the money if you
...
You have to pay quite a lot in advance. Im my case, it were 3218.06 Euro:
