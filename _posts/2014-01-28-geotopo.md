...
* [Definitionen als PDF in A7](https://github.com/MartinThoma/LaTeX-examples/blob/master/documents/GeoTopo/definitions/definitionen.pdf?raw=true) zum Karteikarten-Lenen
...
<strong>Ort</strong>: steht noch nicht fest (Stand: 28.01.2014)<br/>
...
<strong>Ergebnisse</strong>: steht noch nicht fest (Stand: 28.01.2014)<br/>
<strong>Einsicht</strong>: steht noch nicht fest (Stand: 28.01.2014)<br/>
